...
import net.tsherdiwala.mvvmposts.utils.BASE_URL
...
object NetworkModule {
    ...
    @Reusable
    @JvmStatic
    fun createRoom(context:Context): AppDatabase {
        return Room.databaseBuilder(context, AppDatabase::class.java, "posts")
                .build()
    }
